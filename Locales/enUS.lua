...
L["Аггро"] = "Aggro"
L["Включить индикатор"] = "Enable Indicator"
L["Показывает кастомный индикатор аггро и скрывает стандартный Blizzard, пока он активен."] =
"Shows a custom aggro indicator and hides the standard Blizzard one while it is active."
L["Режим"] = "Mode"
L["Рамка"] = "Border"
L["Текст"] = "Text"
L["Текст аггро"] = "Aggro Text"
L["Стрелка"] = "Arrow"
L["Направление"] = "Direction"
...
L["Ширина"] = "Width"
L["Высота"] = "Height"
L["Показать тест аггро"] = "Show Aggro Preview"
L["Скрыть тест аггро"] = "Hide Aggro Preview"
L["Показывает тестовый индикатор аггро без реальной угрозы."] =
"Shows an aggro indicator preview without real threat."
